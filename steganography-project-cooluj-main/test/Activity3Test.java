...
public class Activity3Test{
	...
	@Test
    public void testShowDifferentArea1of5() {
        // create two pictures
        Picture beach = new Picture("beach.jpg");
        Picture robot = new Picture("robot.jpg");
        // run the test
	...
	@Test
    public void testShowDifferentArea2of5() {
	...
	@Test
    public void testShowDifferentArea3of5() {
        // create three pictures 
        Picture temple = new Picture("femaleLionAndHall.jpg");
        Picture robot = new Picture("robot.jpg");
        Picture flower = new Picture("flower1.jpg");
	...
	@Test
    public void testShowDifferentArea4of5() {
        // create three pictures 
        Picture temple = new Picture("femaleLionAndHall.jpg");
        Picture robot = new Picture("robot.jpg");
        Picture flower = new Picture("flower1.jpg");
	...
	@Test
    public void testShowDifferentArea5of5() {
        // create three pictures 
        Picture temple = new Picture("femaleLionAndHall.jpg");
        Picture robot = new Picture("robot.jpg");
        Picture flower = new Picture("flower1.jpg");
